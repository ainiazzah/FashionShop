<div class="container py-5">
    <h1 class="text-center py-4">Kategori</h1>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Molecules\CategoryCard::class, ['path' => $item->path,'name' => $item->name] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('molecules.category-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Molecules\CategoryCard::class))->getConstructor()): ?>
...
</div><?php /**PATH C:\Users\Aini Azzah\My_Project\laravel\e-commerce_simple\resources\views/client/components/organisms/category.blade.php ENDPATH**/ ?>