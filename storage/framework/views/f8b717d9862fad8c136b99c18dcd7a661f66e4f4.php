...
<?php $component = $__env->getContainer()->make(App\View\Components\Molecules\ProductCard::class, ['image' => $item->productImage,'category' => $item->category->name,'title' => $item->title,'price' => $item->price] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('molecules.product-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Molecules\ProductCard::class))->getConstructor()): ?>
...
</div><?php /**PATH C:\Users\Aini Azzah\My_Project\laravel\e-commerce_simple\resources\views/client/components/organisms/products.blade.php ENDPATH**/ ?>