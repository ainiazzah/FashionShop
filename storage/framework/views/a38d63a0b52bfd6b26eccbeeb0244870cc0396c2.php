...
<div class="card">
  <div class="card-body">
    <form method="post" action="<?php echo e(route('productAddImagesSave')); ?>" enctype="multipart/form-data" class="dropzone" id="dropzone" style="border-radius:12px;">
    ...
    <hr/>
    <a href="<?php echo e(route('products')); ?>" class="btn btn-primary float-end">Save</a>
  </div>
</div>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Aini Azzah\My_Project\laravel\e-commerce_simple\resources\views/admin/product/addImages.blade.php ENDPATH**/ ?>