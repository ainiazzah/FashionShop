...
<?php $component = $__env->getContainer()->make(App\View\Components\Organisms\ProductDetail::class, ['dataProduct' => $product] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('organisms.product-detail'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Organisms\ProductDetail::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Organisms\Products::class, ['dataProduct' => $recomendationProducts] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <h1 class="pb-3 mt-2">Produk populer terkini</h1>
...
<?php endif; ?><?php /**PATH C:\Users\Aini Azzah\My_Project\laravel\e-commerce_simple\resources\views/client/productDetail.blade.php ENDPATH**/ ?>