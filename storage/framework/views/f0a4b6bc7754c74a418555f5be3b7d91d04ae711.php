                ...
                <div class="col-md-3 col-12">
                    <table class="order-info">
                        ...
                        <tr>
                            ...
                            <td>&nbsp; : &nbsp;</td>
                            <td><b><u>Rp.<?php echo e($order->order_code); ?></u></b></td>
                        </tr>
                        <tr>
                            <td><b>Total</b></td>
                            <td>&nbsp; : &nbsp;</td>
                            <td><b><u>Rp.<?php echo e($order->total); ?></u></b></td>
                        </tr>
                        <tr>
                            <td><b>Name</b></td>
                            <td>&nbsp; : &nbsp;</td>
                                ...
                                <div class="card-body" style="padding: .8rem;">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <p class="font-bold">Rp.<?php echo e($row->price); ?></p>
                                        </div>
                                        <div class="col-6">
                                            <label for="">Sub Total</label>
                                            <p class="font-bold">Rp.<?php echo $row->price * $row->quantity; ?></p>
                                        </div>
                                        <div class="col-12">
...
<?php /**PATH C:\Users\Aini Azzah\My_Project\laravel\e-commerce_simple\resources\views/client/components/molecules/check-order/data.blade.php ENDPATH**/ ?>