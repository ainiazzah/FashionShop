<table id="cart" class="table table-hover table-striped">
    ...
    <?php if(session('cart')): ?>
        <?php $__currentLoopData = (array) session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr class="item-cart">
                ...
                <td>Rp.<span class="product-subtotal" data-subtotal="<?php echo e($details['price'] * $details['quantity']); ?>"><?php echo e($details['price'] * $details['quantity']); ?></span></td>
                <?php if(!request()->routeIs('clientCheckout')): ?>
                    <td class="actions">
    ...
    <tfoot>
        <tr>
            ...
            <td class="hidden-xs">
                <strong>Total : Rp.<span class="cart-total"><?php echo e($total); ?></span></strong>
            </td>
            <?php if(!request()->routeIs('clientCheckout')): ?>
                <td>
...
</table><?php /**PATH C:\Users\Aini Azzah\My_Project\laravel\e-commerce_simple\resources\views/client/components/molecules/carts/desktop.blade.php ENDPATH**/ ?>