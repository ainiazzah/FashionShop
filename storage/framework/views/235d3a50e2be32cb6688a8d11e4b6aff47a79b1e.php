...
<?php endif; ?>
  <?php if (isset($component)) { $__componentOriginalf3d5d9574db9d5344c84d05745c276249423bb29 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Organisms\CarouselCategory::class, ['category' => $category] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('organisms.carousel-category'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Organisms\CarouselCategory::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf3d5d9574db9d5344c84d05745c276249423bb29)): ?>
<?php $component = $__componentOriginalf3d5d9574db9d5344c84d05745c276249423bb29; ?>
<?php unset($__componentOriginalf3d5d9574db9d5344c84d05745c276249423bb29); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    <h1 class="text-center pb-5">Produk Terkini</h1>
...
<?php endif; ?><?php /**PATH C:\Users\Aini Azzah\My_Project\laravel\e-commerce_simple\resources\views/client/products.blade.php ENDPATH**/ ?>