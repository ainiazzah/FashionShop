<form action="<?php echo e(route('clientProductSearch')); ?>" class="search" method="GET">
...
<a href="<?php echo e(route('clientCarts')); ?>" class="text-decoration-none">
  <div class="cart">
    <span class="badge bg-dark count" id="cartCount"><?php echo e(count((array) session('cart'))); ?></span>
    <i class="bi bi-cart2 mt-2"></i>
  </div>
</a><?php /**PATH C:\Users\Aini Azzah\My_Project\laravel\e-commerce_simple\resources\views/client/components/molecules/navbar/search-bar.blade.php ENDPATH**/ ?>