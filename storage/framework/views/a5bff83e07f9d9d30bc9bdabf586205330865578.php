...
<?php $component = $__env->getContainer()->make(App\View\Components\Molecules\Button::class, ['arrow' => 'true','type' => 'light','icon' => 'bi-arrow-right','align' => 'end','link' => ''.e(route('clientProductDetail', $title)).''] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
</div><?php /**PATH C:\Users\Aini Azzah\My_Project\laravel\e-commerce_simple\resources\views/client/components/molecules/hero/card-product.blade.php ENDPATH**/ ?>